<template>
  ...
  <div class="e">
    <el-button
      ...
      @click="deleteFileOrDirectory(cgxsz)"
      :disabled="this.cgxsz.length === 0"
  ...
  >
    ...
    <el-table-column label="标题" width="300">
      <template #default="scope">
        <span class="a" @click="zxyj(scope.row)">{{
          scope.row.draftTitle
        }}</span>
      </template>
    </el-table-column>
...
export default {
  ...
  methods: {
    ...
    creat() {
      var _this = this;
      this.axios
        .get("http://localhost:8088/TSM/draft/Draft", { params: this.pageInfo })
