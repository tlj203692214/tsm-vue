<template>
	...
	<div class="inbox">
		<p>邮件标题：{{title}}</p>
		<p>收件人：{{staffName2}}</p>
		<p>发件人：{{staffName1}}<span style="padding-left: 40%;">发件时间:{{receivingDate}}</span></p>
		<p><span style="font-size: 20px;">发件内容:</span><span style="font-size: 50px;">{{receivingContent}}</span></p>
	</div>
