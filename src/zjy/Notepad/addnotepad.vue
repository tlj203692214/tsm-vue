<template>
	<div style="background-color:lightblue" :style="{display:add}">
		<el-button style="background-color: blue;color: white;" :icon="CircleCloseFilled" size="mini" @click="addNotepad('ruleForm')"><el-icon><delete-filled /></el-icon>保存并新建</el-button>
		<el-button style="background-color: blue;color: white;" :icon="CircleCloseFilled" size="mini" @click="addNotepadf('ruleForm')"><el-icon><delete-filled /></el-icon>保存并返回</el-button>
	<el-button style="background-color: blue;color: white;" :icon="CircleCloseFilled" size="mini"  @click="fh()"><el-icon><delete-filled /></el-icon>返回</el-button>
	</div>
	<div style="background-color:lightblue" :style="{display:update}">
		
		<el-button style="background-color: blue;color: white;" :icon="CircleCloseFilled" size="mini" @click="updateNotepad('ruleForm')"><el-icon><delete-filled /></el-icon>保存并返回</el-button>
