<template>
  ...
  >
    ...
    <el-button
      ...
      ><el-icon><check /></el-icon>启用</el-button
    >
    <el-button
      style="background-color: #f60; color: white"
      :icon="CircleCloseFilled"
      @click="disablesuggestions(yjxsz)"
      ><el-icon><close-bold /></el-icon>禁用</el-button
    >
  </div>
  <el-table
    border
  ...
  <el-dialog v-model="xgyjx" title="修改意见箱" width="70%" center>
    ...
    <template #footer>
      <span class="dialog-footer">
        <el-button @click="updatesuggestions('ruleForm')"> 保存</el-button>
      </span>

      <span class="dialog-footer">
        <el-button @click="gbjm('ruleForm')"> 关闭</el-button>
      </span>
    </template>
  </el-dialog>
