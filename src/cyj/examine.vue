		  ...
		  <div>
		  	...
		  	<div class="showTableData">
		  		<el-table ref="mt" :data="leaveData" @selection-change="handeselect" style="width: 100%;">
		  			...
		  			<el-table-column prop="leaveContent" width="150" :show-overflow-tooltip="true" label="请假原因"></el-table-column>
			...
			<el-dialog v-model="insertLeave" title="新增员工请假条" width="52%" center>
			    <el-form 
			        ref="ruleForm"
			        :model="ruleForm"
			        :rules="rules"
			...
			<el-dialog v-model="updateLeave" title="请假审批" width="44%" center>
			    <el-form ref="ruleupForm" :model="ruleupForm" :rules="Uprules" label-width="120px" class="demo-ruleForm">
			        <el-form-item label="请假人" prop="name">
		  ...
		  <div>
		  	...
		  	<div class="showTableData">
		  		<el-table ref="mt" :data="businessData" @selection-change="handeselect" style="width: 100%;">
		  			...
		  			<el-table-column prop="staffbusinessContent" width="150" :show-overflow-tooltip="true" label="出差原因"></el-table-column>
			...
			<el-dialog v-model="addBusiness" title="新增员工出差信息" width="52%" center>
			    <el-form 
			        ref="businessForm"
			        :model="businessForm"
			        :rules="rules"
		...
		methods:{
			...
			insertleave(addformName){
				this.$refs[addformName].validate((valid) => {
					if(valid){
						var _this=this
						this.axios.post("http://localhost:8088/TSM/staffleave/insetleave",{
			...
			addbusiness(addformName){	
				his.$refs[addformName].validate((valid) => {
					if(valid){
						var _this=this
						this.axios.post("http://localhost:8088/TSM/staffbusiness/insertbusiness",{
